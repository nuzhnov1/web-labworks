...
class Vendors {
    ...
    /**
     * Получить HTML представление списка поставщиков
     * @param int|null $selected - какое выбрано поле
     * @return string - HTML представление списка поставщиков
    ...
    public function get_html_list($selected = null) {
        $query_result = $this->db_ref->execute_query("SELECT * FROM vendors;");
        if (!$query_result)
